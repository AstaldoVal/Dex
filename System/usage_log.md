...
## Health / Physical (2 features)

- [ ] Daily physical questionnaire (`/physical-daily-checkin`)
- [ ] Physical readiness and prescription (`/physical-check-custom`)
...
## Career Development (7 features)

- [ ] Career setup (`/career-setup`)
- [x] linkedin_profile_audit_completed (`/linkedin-profile-audit` — LinkedIn profile audit skill)
...
- [x] Email processing (`/email-process`)
...
- [x] Web research toolkit (`/web-research`)
