---
name: task-bundle-engineering
description: Router category `engineering` — read .claude/reference/task-skill-bundles.md then only listed paths.
---

# Task bundle: engineering

1. Read `.claude/reference/task-skill-bundles.md` and find the section `### engineering`.
