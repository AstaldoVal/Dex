---
name: task-bundle-research
description: Router category `research` — read .claude/reference/task-skill-bundles.md then only listed paths.
---

# Task bundle: research

1. Read `.claude/reference/task-skill-bundles.md` and find the section `### research`.
